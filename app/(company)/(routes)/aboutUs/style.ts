...
const AboutHeroText = tw.h1`text-[72px] font-chela font-bod leading-[70px] pt-8 text-custom-greaner text-balance`

export { AboutLi, AboutConnector, FaqContainer,  AboutHero, AboutHeroText };
