  ...
  return (
    <div className="items-center flex flex-col justify-center gap-10">
      ...
      <div className="w-full  gap-3 flex max-lg:flex-col justify-center max-lg:w-[98.1%] mx-auto max-md:items-center my-10">
        ...
        <div className="max-sm:overflow-x-scroll grid xl:ml-auto mx-auto pt-14 h-fit  w-auto  gap-x-3 gap-4 grid-cols-2 md:grid-cols-3 grid-flow-row-dense lg:grid-cols-3 xl:grid-cols-4 sm:grid-cols-3">
          <ProductCard />
          <ProductCard />
          <ProductCard />
          <ProductCard />
